#ifndef SRC_CPP_PARSER_PLANTUML_ACTIVITY_DIAGRAM_ACTIVITY_PARSER_HPP
#define SRC_CPP_PARSER_PLANTUML_ACTIVITY_DIAGRAM_ACTIVITY_PARSER_HPP
...
public:
  ...
  Graph Parse(Logs logs, const bool enable_output = false);
...
private:
  ...
  void HandleWhileStatement(Logs &logs,
                            Graph &graph,
                            std::optional<std::uint64_t> &node_parent,
                            std::uint64_t &node_id_ctr,
                            std::uint64_t &edge_id_ctr,
  ...
  void HandleRepeatStatement(Logs &logs,
                             Graph &graph,
                             std::optional<std::uint64_t> &node_parent,
                             std::uint64_t &node_id_ctr,
                             std::uint64_t &edge_id_ctr,
...
#endif // SRC_CPP_PARSER_PLANTUML_ACTIVITY_DIAGRAM_ACTIVITY_PARSER_HPP
