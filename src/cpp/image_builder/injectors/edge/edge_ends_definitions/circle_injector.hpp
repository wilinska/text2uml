#ifndef SRC_CPP_IMAGE_BUILDER_INJECTORS_EDGE_EDGE_ENDS_DEFINITIONS_CIRCLE_INJECTOR_HPP
#define SRC_CPP_IMAGE_BUILDER_INJECTORS_EDGE_EDGE_ENDS_DEFINITIONS_CIRCLE_INJECTOR_HPP

#include "src/cpp/image_builder/injectors/i_injector.hpp"
#include "tinyxml2.h"

class EdgeEndCircleInjector : public IInjector
{
public:
  EdgeEndCircleInjector(tinyxml2::XMLDocument &doc) : doc_(doc) {}
...
#endif // SRC_CPP_IMAGE_BUILDER_INJECTORS_EDGE_EDGE_ENDS_DEFINITIONS_CIRCLE_INJECTOR_HPP
